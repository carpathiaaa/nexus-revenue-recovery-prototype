...
// Two distinct premade ElevenLabs voices so the rep and the (simulated) customer
// sound like different people. Override per deployment via env if you like.
const VOICES = {
  agent: process.env.ELEVENLABS_VOICE_AGENT || "21m00Tcm4TlvDq8ikWAM", // Rachel — warm, clear
  customer: process.env.ELEVENLABS_VOICE_CUSTOMER || "pNInz6obpgDQGcFmaJgB" // Adam — distinct, casual
};
